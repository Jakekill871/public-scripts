-- games I recommend. KAT, Metaverse Shoot Out, Phantom Forces, Bad Buissness, Big Paintball, Typical Tycoons(God Tycoon, Anime Tycoon, ETC), Any RPG(Ex. Blox Piece, King Legacy, Swordburst 2, ETC)
...
WalkspeedOff = {2377868063, 6172932937, 292439477, 4716045691, 301549746, 4651779470}
...
function BadBusiness()
for i, v in pairs(getgc(true)) do
if typeof(v) == "table" and rawget(v, "InitProjectile") then
if v.TS then
_G.CharacterTable = v
end
end
...
v.Character = _G.CharacterTable.TS.Characters:GetCharacter(v).Body
v.Character.Chest.Name = "HumanoidRootPart"
end)
end
end

function upvalue(change, new)
...
local venyx = library.new("Venyx UI Lib(Public), Scripts by Jakekill871", 5013109572)
...
-- first page
local page = venyx:addPage("Phantom Forces", 5012544693)
local section1 = page:addSection("Toggles")
local section2 = page:addSection("Sliders")

section1:addToggle("Inf Ammo Toggle", nil, function(toggle)
if toggle == true then
repeat
for i,v in pairs(getreg()) do
...
section1:addToggle("Automatic Guns Toggle", nil, function(toggle)
if toggle == true then
for i,v in pairs(getreg()) do
...
section2:addSlider("FireRate", 0, 1, 500, function(value)
for i,v in pairs(getreg()) do
...
local page2 = venyx:addPage("Big Paintball", 5012544693)
local section3 = page2:addSection("Gun Mods")

section3:addToggle("Gun Mods", nil, function(toggle)
if toggle == true then
_G.GetGC = true
upvalue("shotrate", 0.0000001)
upvalue("automatic", true)
upvalue("velocity", 5000000)
else
_G.GetGC = true
upvalue("shotrate", 0.125)
upvalue("automatic", false)
upvalue("velocity", 500)
end
end)

local page3 = venyx:addPage("Shoot Out", 5012544693)
local section4 = page3:addSection("Gun Mods")

section4:addToggle("Gun Mods", nil, function(toggle)
if toggle == true then
for i,v in pairs(getgc(true)) do 
    if typeof(v) == "table" and rawget(v, "MAX_AMMO") then
            v.MAX_AMMO = 123123123123
            v.RECOIL_STRENGTH = 0
            v.SPREAD = 0
            v.AUTOMATIC = true
            v.MAX_DAMAGE = 99999
...
local page4 = venyx:addPage("Jailbreak", 5012544693)
local section5 = page4:addSection("Gun Mods")

section5:addToggle("Gun Mods", nil, function(toggle)
if toggle == true then
for i,v in pairs(getgc(true)) do 
...
-- second page
local theme = venyx:addPage("Theme Changer", 5012544693)
...
elseif tonumber(game.PlaceId) == 3527629287 then 
venyx:SelectPage(venyx.pages[2], true)
elseif tonumber(game.PlaceId) == 4738545896 then 
venyx:SelectPage(venyx.pages[3], true)
elseif tonumber(game.PlaceId) == 606849621 then 
...
local vector, thing = game:GetService("Workspace").CurrentCamera:WorldToScreenPoint(v.Character.Head.Position)
...
local vector, onScreen = game:GetService("Workspace").CurrentCamera:WorldToScreenPoint(_G.LowestPlayer.Head.Position)
...
if game:GetService("Players").LocalPlayer.Character and game:GetService("Players").LocalPlayer.Character:FindFirstChild("LeftLowerArm") then
_G.R15 = true
elseif game:GetService("Players").LocalPlayer.Character and game:GetService("Players").LocalPlayer.Character:FindFirstChild("Left Arm") then
_G.R15 = false
end
spawn(function()
if _G.SAPType ~= 4 then
if _G.R15 == false then
local Square = Drawing.new("Quad")
repeat
local Point0, Visible0 = game:GetService("Workspace").CurrentCamera:WorldToScreenPoint(Vector3.new(v.Character.HumanoidRootPart.Position.x + 0, v.Character.HumanoidRootPart.Position.y + 0, v.Character.HumanoidRootPart.Position.z + 0))
local Point1 = game:GetService("Workspace").CurrentCamera:WorldToScreenPoint(Vector3.new(v.Character["Right Arm"].Position.x + 0, v.Character["Right Arm"].Position.y + 2, v.Character["Right Arm"].Position.z + 0))
local Point2 = game:GetService("Workspace").CurrentCamera:WorldToScreenPoint(Vector3.new(v.Character["Right Arm"].Position.x + 0, v.Character["Right Arm"].Position.y - 4, v.Character["Right Arm"].Position.z + 0))
local Point3 = game:GetService("Workspace").CurrentCamera:WorldToScreenPoint(Vector3.new(v.Character["Left Arm"].Position.x + 0, v.Character["Left Arm"].Position.y + 2, v.Character["Left Arm"].Position.z + 0))
local Point4 = game:GetService("Workspace").CurrentCamera:WorldToScreenPoint(Vector3.new(v.Character["Left Arm"].Position.x + 0, v.Character["Left Arm"].Position.y - 4, v.Character["Left Arm"].Position.z + 0))
...
repeat
local Point0, Visible0 = game:GetService("Workspace").CurrentCamera:WorldToScreenPoint(Vector3.new(v.Character.HumanoidRootPart.Position.x + 0, v.Character.HumanoidRootPart.Position.y + 0, v.Character.HumanoidRootPart.Position.z + 0))
local Point1 = game:GetService("Workspace").CurrentCamera:WorldToScreenPoint(Vector3.new(v.Character["RightLowerArm"].CFrame.x + 0, v.Character["RightLowerArm"].CFrame.y + 2, v.Character["RightLowerArm"].CFrame.z + 0))
local Point2 = game:GetService("Workspace").CurrentCamera:WorldToScreenPoint(Vector3.new(v.Character["RightLowerArm"].CFrame.x + 0, v.Character["RightLowerArm"].CFrame.y - 4, v.Character["RightLowerArm"].CFrame.z + 0))
local Point3 = game:GetService("Workspace").CurrentCamera:WorldToScreenPoint(Vector3.new(v.Character["LeftLowerArm"].CFrame.x + 0, v.Character["LeftLowerArm"].CFrame.y + 2, v.Character["LeftLowerArm"].CFrame.z + 0))
local Point4 = game:GetService("Workspace").CurrentCamera:WorldToScreenPoint(Vector3.new(v.Character["LeftLowerArm"].CFrame.x + 0, v.Character["LeftLowerArm"].CFrame.y - 4, v.Character["LeftLowerArm"].CFrame.z + 0))
Square.Visible = Visible0
Square.PointA = Vector2.new(Point2.x, Point2.y)
Square.PointB = Vector2.new(Point1.x, Point1.y)
Square.PointC = Vector2.new(Point3.x, Point3.y)
...
Square.Transparency = 1
repeat
local vector, Visible1 = game:GetService("Workspace").CurrentCamera:WorldToScreenPoint(v.Head.Position)
...
repeat wait() until _G.CharacterTable ~= nil and v.Character ~= nil and v.Character:FindFirstChild('HumanoidRootPart') or v.Character and v.Character:FindFirstChild('HumanoidRootPart')
...
function ESP(toggle)
repeat wait() until _G.FPSTargetList ~= nil or _G.SAPType == 4
if toggle == true then
...
if game:GetService("Players").LocalPlayer.Character:FindFirstChildOfClass('Humanoid') and _G.WalkspeedToggle ~= false then
...
pcall(function()
for i,v in pairs(WalkspeedOff) do
...
_G.FPSTargetList = {}
for i,v in pairs(game:GetService("Players"):GetChildren()) do
if tonumber(game.PlaceId) == 3233893879 then
repeat wait() until _G.CharacterTable ~= nil
if _G.CharacterTable.TS.Teams:ArePlayersFriendly(v, game:GetService("Players").LocalPlayer) then
table.insert(_G.FPSTargetList, v.Name)
elseif _G.CharacterTable.TS.Teams:ArePlayersFriendly(v, game:GetService("Players").LocalPlayer) ~= true and _G.SAPType == 2 then
table.insert(_G.FPSTargetList, v.Name)
...
if tonumber(game.PlaceId) == 292439477 then
PhantomForces()
elseif tonumber(game.PlaceId) == 3233893879 then
BadBusiness()
end
end
end)
...
while true do
NPCCheck()
if _G.Player and _G.Player:FindFirstChildOfClass('Humanoid') and _G.WalkspeedToggle ~= false then
...
pcall(function()
if _G.WalkspeedToggle ~= false then
...
mt.__index = newcclosure(function(i, v) if _G.Player:FindFirstChildOfClass('Humanoid') and v:lower() == 'walkspeed' or v:lower() == 'WalkSpeed' then return 16 end return index(i, v) end)
...
do -- Example UI
	local Window = library:AddWindow("Bald Hub.", {
		main_color = Color3.fromRGB(255, 170, 0),
		min_size = Vector2.new(480, 335),
		toggle_key = Enum.KeyCode.RightShift,
		can_resize = true,
	})
	...
	do -- Elements
		Tab:AddLabel("Made by Jakekill871#9002")
		
		Tab:AddLabel("Uses Infinite Yields ESP and Singularities UI Lib")
		
		Tab:AddLabel("Tween by Walmort")
		
		Tab:AddLabel("My discord is SqgAa9Fbft")
		...
		_G.NHBS = Tab2:AddSlider("NPC Distance (How far you will be from it)", function(NDistance)
		...
		_G.SAPType = 3
		elseif SAP == "Everyone(If Custom Characters)" then
		_G.SAPType = 4
		end
		end)
		...
		_G.Dropdown2:Add("Everyone(If Custom Characters)")
		
		Tab3:AddTextBox("Upvalue Name(Ex. Ammo)/Value(Ex. 19)", function(UN)
		_G.ChangeValue = UN
		end, {
			["clear"] = false,
		})
		
		Tab3:AddTextBox("Upvalue New Value(Ex. 999 or 0.01, or true/false)", function(UV)
		print(UV)
		if tonumber(UV) ~= nil or UV == "true" or UV == "false" then
		upvalue(_G.ChangeValue, UV)
		end
		end, {
			["clear"] = false,
		})
		...
		Tab3:AddSwitch("Player Esp Toggle (Use Drawing Lib in Strucid)", function(tingthing)
		_G.ESPTog = tingthing
        if _G.ESPTog == true then
        repeat ESP(true)
        wait(7)
        _G.ESPTog = false
        ESP(false)
		...
		Tab3:AddSwitch("Use Drawing Lib(For ESP, Laggy)", function(DL)
        _G.DrawingLib = DL
		end)
		
		Tab3:AddSwitch("getgc (for upvalue stuff, not always needed)", function(GC)
        _G.GetGC = GC
		end)
		
		Tab3:AddButton("Gun Hax GUI (Venyx UI has many games supported)", function()
		GunMods()
		end)
		
		Tab3:AddButton("Print all Upvalues", function()
		upvalue("Change", Bruh)
		end)
...
Dropdown7:Add(v.Name)
	    ...
	    if _G.Player:FindFirstChildOfClass('Humanoid') and _G.WalkspeedToggle ~= false then
        _G.Walkspeed = walk
        WalkSpeedChange()
        end
        end, {
	    ...
	    local walks = Tab4:AddSlider("Walk Speed Slider (Disabled For This Game)", function() end)
		end
        end)
